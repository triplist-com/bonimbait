...
description: Extract and formalize domain terminology from the current conversation into a consistent glossary, saved to UBIQUITOUS_LANGUAGE.md. Use when user wants to define terms, create a glossary, establish domain language, or mentions "ubiquitous language".
---
